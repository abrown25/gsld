...
alias gsl_matrix_int_const_view = const(_gsl_matrix_int_const_view);
...
_gsl_matrix_int_const_view
gsl_matrix_int_const_view_vector (const(gsl_vector_int)* v, const(size_t) n1, const(size_t) n2);

_gsl_matrix_int_const_view
gsl_matrix_int_const_view_vector_with_tda (const(gsl_vector_int)* v, const(size_t) n1, const(size_t) n2, const(size_t) tda);
