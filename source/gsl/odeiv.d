...
{
  int function(double t, const(double)* y, double* dydt, void* params) function_;
  int function(double t, const(double)* y, double* dfdy, double* dfdt, void* params) jacobian;
  size_t dimension;
  void * params;
}
...
struct gsl_odeiv_step_type
{
  ...
  int function(void* state, size_t dim, double t, double h, double* y, double* yerr, const double* dydt_in, double* dydt_out, const gsl_odeiv_system* dydt) apply;
...
struct gsl_odeiv_control_type
{
  ...
  int function(void* state, size_t dim, uint ord, const(double)* y, const(double)* yerr, const(double)* yp, double* h) hadjust;
  void function(void* state) free;
}
 ...
 */
enum GSL_ODEIV_HADJ_INC = 1;  /* step was increased */
enum GSL_ODEIV_HADJ_NIL = 0;  /* step unchanged     */
enum GSL_ODEIV_HADJ_DEC = -1; /* step decreased     */
...
struct gsl_odeiv2_step_type
{
  ...
  int gives_exact_dydt_out;
  void* function(size_t dim) alloc;
  int function(void* state, size_t dim, double t, double h, double* y,
                double* yerr, const(double)* dydt_in, double* dydt_out,
                const(gsl_odeiv2_system)* dydt) apply;
  int function(void* state, const(gsl_odeiv2_driver)* d) set_driver;
  int function(void* state, size_t dim) reset;
  uint function(void* state) order;
  void function(void* state) free;
}
...
struct gsl_odeiv2_control_type
{
  ...
  int function(void* state, double eps_abs, double eps_rel, double a_y, double a_dydt) init;
  int function(void* state, size_t dim, uint ord, const(double)* y, const(double)* yerr, const(double)* yp, double* h) hadjust;
  int function(void* state, const(double) y, const(double) dydt, const(double) h, const size_t ind, double* errlev) errlevel;
  int function(void* state, const(gsl_odeiv2_driver)* d) set_driver;
  void function(void* state) free;
}
...
gsl_odeiv2_control *gsl_odeiv2_control_scaled_new(double eps_abs, double eps_rel, double a_y, double a_dydt, 
...
int gsl_odeiv2_evolve_apply (gsl_odeiv2_evolve* e, gsl_odeiv2_control* con, gsl_odeiv2_step* step,
                             const gsl_odeiv2_system* dydt, double* t, double t1, double* h, double* y);
int gsl_odeiv2_evolve_apply_fixed_step (gsl_odeiv2_evolve* e, gsl_odeiv2_control* con, gsl_odeiv2_step* step,
                                        const gsl_odeiv2_system* dydt, double* t, const(double) h0, double* y);
...
gsl_odeiv2_driver* gsl_odeiv2_driver_alloc_y_new (const(gsl_odeiv2_system)* sys,
                                                  const(gsl_odeiv2_step_type)* T, const(double) hstart,
                                                  const(double) epsabs, const(double) epsrel);
gsl_odeiv2_driver* gsl_odeiv2_driver_alloc_yp_new (const(gsl_odeiv2_system)* sys,
                                                   const(gsl_odeiv2_step_type)* T, const(double) hstart,
                                                   const(double) epsabs, const(double) epsrel);
gsl_odeiv2_driver* gsl_odeiv2_driver_alloc_scaled_new (const(gsl_odeiv2_system)* sys, const(gsl_odeiv2_step_type)* T, 
                                                       const(double) hstart, const(double) epsabs,
                                                       const(double) epsrel, const(double) a_y,
                                                       const(double) a_dydt, const(double)* scale_abs);
gsl_odeiv2_driver* gsl_odeiv2_driver_alloc_standard_new (const(gsl_odeiv2_system)* sys, const(gsl_odeiv2_step_type)* T, const(double) hstart,
                                                         const(double) epsabs, const(double) epsrel, const(double) a_y,const(double) a_dydt);
...
int gsl_odeiv2_driver_set_nmax (gsl_odeiv2_driver* d, const(ulong) nmax);
int gsl_odeiv2_driver_apply (gsl_odeiv2_driver* d, double* t, const(double) t1, double* y);
int gsl_odeiv2_driver_apply_fixed_step (gsl_odeiv2_driver* d, double* t, const(double) h, const(ulong) n, double* y);
