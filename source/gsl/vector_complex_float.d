module gsl.vector_complex_float;
...
alias gsl_vector_complex_float_const_view = const _gsl_vector_complex_float_const_view;
...
gsl_vector_complex_float* gsl_vector_complex_float_alloc_from_block (gsl_block_complex_float* b, 
                                           const(size_t) offset, 
                                           const(size_t) n, 
                                           const size_t stride);

gsl_vector_complex_float* gsl_vector_complex_float_alloc_from_vector (gsl_vector_complex_float* v, 
                                             const(size_t) offset, 
                                             const(size_t) n, 
                                             const size_t stride);
