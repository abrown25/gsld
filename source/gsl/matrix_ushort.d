...
alias gsl_matrix_ushort_const_view = const(_gsl_matrix_ushort_const_view);
...
_gsl_matrix_ushort_view
gsl_matrix_ushort_view_array (ushort* base,
                             const(size_t) n1, 
                             const(size_t) n2);

_gsl_matrix_ushort_view
gsl_matrix_ushort_view_array_with_tda (ushort* base, 
                                      const(size_t) n1, 
                                      const(size_t) n2,
                                      const(size_t) tda);
...
_gsl_matrix_ushort_const_view
gsl_matrix_ushort_const_view_array (const(ushort)* base,
                                   const(size_t) n1, 
                                   const(size_t) n2);

_gsl_matrix_ushort_const_view
gsl_matrix_ushort_const_view_array_with_tda (const(ushort)* base, 
                                            const(size_t) n1, 
                                            const(size_t) n2,
                                            const(size_t) tda);
