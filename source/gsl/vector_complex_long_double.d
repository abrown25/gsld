module gsl.vector_complex_long_double;
...
alias 	gsl_vector_complex_long_double_const_view = const(_gsl_vector_complex_long_double_const_view);
...
gsl_vector_complex_long_double_view_array (real* base,
                                     size_t n);

_gsl_vector_complex_long_double_view
gsl_vector_complex_long_double_view_array_with_stride (real* base,
                                                 size_t stride,
                                                 size_t n);

_gsl_vector_complex_long_double_const_view
gsl_vector_complex_long_double_const_view_array (const(real)*base,
                                           size_t n);

_gsl_vector_complex_long_double_const_view
gsl_vector_complex_long_double_const_view_array_with_stride (const(real)*base,
                                                       size_t stride,
                                                       size_t n);
