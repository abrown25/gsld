...
alias gsl_vector_ulong_const_view = const _gsl_vector_ulong_const_view;
...
_gsl_vector_ulong_view gsl_vector_ulong_view_array (ulong* v, size_t n);
_gsl_vector_ulong_view gsl_vector_ulong_view_array_with_stride (ulong* base, size_t stride, size_t n);
_gsl_vector_ulong_const_view gsl_vector_ulong_const_view_array (const(ulong)* v, size_t n);
_gsl_vector_ulong_const_view gsl_vector_ulong_const_view_array_with_stride (const(ulong)* base, size_t stride, size_t n);
...
void gsl_vector_ulong_set_all (gsl_vector_ulong* v, ulong x);
...
ulong gsl_vector_ulong_max (const(gsl_vector_ulong)* v);
ulong gsl_vector_ulong_min (const(gsl_vector_ulong)* v);
void gsl_vector_ulong_minmax (const(gsl_vector_ulong)* v, ulong* min_out, ulong* max_out);
...
ulong gsl_vector_ulong_get (const(gsl_vector_ulong)* v, const(size_t) i);
void gsl_vector_ulong_set (gsl_vector_ulong* v, const(size_t) i, ulong x);
ulong*  gsl_vector_ulong_ptr (gsl_vector_ulong* v, const(size_t) i);
const(ulong)* gsl_vector_ulong_const_ptr (const(gsl_vector_ulong)* v, const(size_t) i);
