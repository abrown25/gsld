...
alias gsl_matrix_long_double_const_view = const(_gsl_matrix_long_double_const_view);
...
_gsl_matrix_long_double_view
gsl_matrix_long_double_view_array (real* base,
                             const(size_t) n1, 
                             const(size_t) n2);

_gsl_matrix_long_double_view
gsl_matrix_long_double_view_array_with_tda (real* base, 
                                      const(size_t) n1, 
                                      const(size_t) n2,
                                      const(size_t) tda);
...
_gsl_matrix_long_double_const_view
gsl_matrix_long_double_const_view_array (const(real)* base,
                                   const(size_t) n1, 
                                   const(size_t) n2);

_gsl_matrix_long_double_const_view
gsl_matrix_long_double_const_view_array_with_tda (const(real)* base, 
                                            const(size_t) n1, 
                                            const(size_t) n2,
                                            const(size_t) tda);
