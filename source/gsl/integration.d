...
//enum gsl_integration_qawo_enum = gsl_integration_qawo_table.gsl_integration_qawo_enum;
...
enum GSL_INTEG_GAUSS15 = 1;      /* 15 point Gauss-Kronrod rule */
enum GSL_INTEG_GAUSS21 = 2;      /* 21 point Gauss-Kronrod rule */
enum GSL_INTEG_GAUSS31 = 3;      /* 31 point Gauss-Kronrod rule */
enum GSL_INTEG_GAUSS41 = 4;      /* 41 point Gauss-Kronrod rule */
enum GSL_INTEG_GAUSS51 = 5;      /* 51 point Gauss-Kronrod rule */
enum GSL_INTEG_GAUSS61 = 6;      /* 61 point Gauss-Kronrod rule */

void gsl_integration_qk (const(int) n, const(double)* xgk, const(double)* wg, const(double)* wgk, double* fv1, double* fv2, 
                         const(gsl_function)* f, double a, double b, double* result, double* abserr, double* resabs, double* resasc);

int gsl_integration_qng (const(gsl_function)* f, double a, double b, double epsabs, double epsrel, 
                         double* result, double* abserr, size_t* neval);

int gsl_integration_qag (const(gsl_function)* f, double a, double b, double epsabs, double epsrel, size_t limit,
...
int gsl_integration_cquad (const(gsl_function)* f, double a, double b, double epsabs, double epsrel,
		       gsl_integration_cquad_workspace* ws, double* result, double* abserr, size_t* nevals);
